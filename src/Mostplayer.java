...
public class Mostplayer implements Comparable<Mostplayer> {
	public int id;
	...
	public Mostplayer(int id, int skillLevel,boolean busy) {
		this.id = id;
		this.skillLevel = skillLevel;
		this.busy=busy;
	}	
	
	public Mostplayer(int id, int skillLevel,boolean busy,double current_request_time,double current_training_time) {
		this.id = id;
		this.skillLevel = skillLevel;
		this.busy=busy;
	...
	public Mostplayer(int id, double general_waiting_time ) {
		this.id=id;
		this.general_waiting_time=general_waiting_time;
	}

	
	// for most time player queue sorting
	@Override
	public int compareTo(Mostplayer xxx) {
		if(Math.abs(general_waiting_time-xxx.general_waiting_time)>0.000001) {
			return Double.compare( xxx.general_waiting_time, general_waiting_time);       
