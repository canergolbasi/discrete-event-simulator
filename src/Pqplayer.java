...
public class Pqplayer implements Comparable<Pqplayer> {
	public int id;
	...
	double sum_waiting_time_coach;//7
	double sum_waiting_time_physiotherapist; //8 
	double sum_waiting_time_masseur;  //9
	double general_waiting_time;
	
	
	
	public Pqplayer(int id, int skillLevel,boolean busy) {
		this.id = id;
	...
	public Pqplayer(int id, int skillLevel,boolean busy,double current_request_time,double current_training_time) {
		this.id = id;
		this.skillLevel = skillLevel;
		this.busy=busy;
	...
	public Pqplayer(int id, double general_waiting_time ) {
		this.id=id;
		this.general_waiting_time=general_waiting_time;
	}

	
	//for physioterapist queue sorting
	@Override
	public int compareTo(Pqplayer xxx) {
		if(Math.abs(current_training_time-xxx.current_training_time)>0.000001) {
			return Double.compare(xxx.current_training_time, current_training_time);  // higher to lower
