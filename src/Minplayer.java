...
public class Minplayer implements Comparable<Minplayer> {
	public int id;
	...
	public Minplayer(int id, int skillLevel,boolean busy) {
		this.id = id;
	...
	// for queues
	public Minplayer(int id, int skillLevel,boolean busy,double current_request_time,double current_training_time) {
		this.id = id;
		this.skillLevel = skillLevel;
		this.busy=busy;
	...
	public Minplayer(int id, double general_waiting_time ) {
		this.id=id;
		this.general_waiting_time=general_waiting_time;
	}

	
	// for most time min time player queue sorting
	@Override
	public int compareTo(Minplayer xxx) {
		if(Math.abs(general_waiting_time-xxx.general_waiting_time)>0.000001) {
			return Double.compare(general_waiting_time, xxx.general_waiting_time);       // lower to higher
