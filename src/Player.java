...
public class Player implements Comparable<Player> {
	...
	public Player(int id, int skillLevel,boolean busy) {
		this.id = id;
		this.skillLevel = skillLevel;
		this.busy=busy;
	}
	
	// for player arraylist
	public Player(int id, int skillLevel,boolean busy,double current_request_time,double current_training_time) {
		this.id = id;
		this.skillLevel = skillLevel;
		this.busy=busy;
	...
	public Player(int id, double general_waiting_time ) {
		this.id=id;
