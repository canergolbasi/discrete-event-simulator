...
public class Cqplayer implements Comparable<Cqplayer> {
	public int id;
	...
	public Cqplayer(int id, int skillLevel,boolean busy) {
		this.id = id;
	...
	// for queue
	public Cqplayer(int id, int skillLevel,boolean busy,double current_request_time,double current_training_time) {
		this.id = id;
		this.skillLevel = skillLevel;
		this.busy=busy;
	...
	// for most time physiotherap sorting
	public Cqplayer(int id, double general_waiting_time ) {
		this.id=id;
	...
	//sorting coach queue
	@Override
	public int compareTo(Cqplayer xxx) {
		if(Math.abs(current_request_time-xxx.current_request_time)>0.000001) {
